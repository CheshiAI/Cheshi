...
function watchMainSources(): FSWatcher[] {
  const sourcePaths = [
    ...
    ...['autopilot-browser.mts', 'autopilot-actions.mts', 'autopilot-interaction.mts', 'autopilot-key.mts', 'autopilot-model.mts', 'autopilot-model-request.mts', 'autopilot-page.mts',
      'autopilot-input.mts', 'autopilot-progress.mts', 'autopilot-field-text.mts',
