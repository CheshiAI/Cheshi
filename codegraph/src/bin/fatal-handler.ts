 ...
 * try/catch in the MCP transport and the file watcher's own `'error'`
 * handlers) — i.e. the process is in an undefined state. Node's default in
 * that case is to print and exit non-zero. The CLI
