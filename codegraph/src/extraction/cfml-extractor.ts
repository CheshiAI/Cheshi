...
export class CfmlExtractor {
  ...
  private extractTagBased(): void {
    ...
    // nullable; runtime child arrays contain concrete nodes.
    this.walkProgram(tree.rootNode as unknown as SyntaxNode, fileNode.id);
  }
  ...
  private delegateScriptTag(scriptTag: SyntaxNode, parentId: string | undefined, parentClassName?: string): void {
    ...
    this.appendUnresolvedReferences(result.unresolvedReferences, startLine, innerFileNodeId, parentId);
  ...
  private appendUnresolvedReferences(
    refs: UnresolvedReference[],
    startLine: number,
    innerFileNodeId: string | undefined,
