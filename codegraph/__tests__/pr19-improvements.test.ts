...
// =============================================================================
// Graph Traversal 'both' Direction Fix
// (uses the Bun-backed CodeGraph integration)
// =============================================================================
...
describe('Graph Traversal Both Direction', () => {
  ...
  it('should traverse both directions from a node', async () => {
    const CodeGraph = (await import('../src')).default;
...
describe('Schema v2 Migration', () => {
  ...
  it('should have migration for version 2', async () => {
...
describe('MCP Tool Improvements', () => {
  ...
  it('binds symbol lookup and formatting methods to handler state', async () => {
    const { ToolHandlerState: ToolHandler } = await import('../src/mcp/tool-handler-state');
...
`);
    ...
    it('should return all definitions when multiple symbols share the same name', async () => {
      const { ToolHandlerState: ToolHandler } = await import('../src/mcp/tool-handler-state');
      const CodeGraph = (await import('../src')).default;
...
`);
    ...
    it('should return no matches when symbol is not found', async () => {
      const { ToolHandlerState: ToolHandler } = await import('../src/mcp/tool-handler-state');
      const CodeGraph = (await import('../src')).default;
...
describe('CLI uninit', () => {
  ...
  it('should uninitialize a project via CodeGraph.uninitialize()', async () => {
    const CodeGraph = (await import('../src')).default;
...
describe('Tree-sitter WASM Setup', () => {
  it('should use web-tree-sitter and tree-sitter-wasms in CodeGraph dependencies', () => {
