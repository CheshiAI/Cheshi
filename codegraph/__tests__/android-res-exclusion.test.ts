...
// Keep the canonical Android namespace URI in generated XML without making it
// an unsafe-HTTP hyperlink in IntelliJ's inspections.
const ANDROID_XMLNS = 'http' + '://schemas.android.com/apk/res/android';
...
describe('Android resource XML exclusion (#1047)', () => {
  ...
  beforeEach(async () => {
    ...
    write('app/src/main/res/drawable/ic_foo.xml', `<vector xmlns:android="${ANDROID_XMLNS}" android:height="24dp"/>\n`);
    write('app/src/main/res/menu/main_menu.xml', `<menu xmlns:android="${ANDROID_XMLNS}"><item android:id="@+id/x"/></menu>\n`);
    ...
    write('app/src/main/res/raw/payload.xml', '<payload><item value="1"/></payload>\n');
