...
test('shows version and build independently with the supplied logo', () => {
  ...
  assert.match(page, /<\/dl>\s*<a class="changelog" href="https:\/\/github\.com\/CheshiAI\/Cheshi\/blob\/main\/CHANGELOG\.md" target="_blank" rel="noopener noreferrer">Changelog<\/a>/u);
